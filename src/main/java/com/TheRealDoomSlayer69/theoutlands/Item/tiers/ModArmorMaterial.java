...
public enum ModArmorMaterial implements ArmorMaterial {
    OUTERIUM("outerium", 13, new int[]{5, 7, 8, 6}, 15,
            SoundEvents.ARMOR_EQUIP_DIAMOND, 6F, 0.2F, () -> {
        return Ingredient.of(ModItems.OUTERIUM_INGOT.get());
    });
    ...
    public String getName() {
        return TheOutlands.MOD_ID + ":" + this.name;
    }
